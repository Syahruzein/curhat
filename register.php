              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-2">Daftar Akun Baru</h1>
                    <h1 class="h5 text-gray-900 mb-4">Curhatan Mahasiswa PENS</h1>
                  </div>
                  <form class="user" method="post" action="simpan_mahasiswa.php">
                    <div class="form-group">
                      <input type="text" name="nrp" class="form-control form-control-user" placeholder="NRP">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <input type="text" name="telp" class="form-control form-control-user" placeholder="No.Telepon">
                    </div>
                    <div class="form-group">
                  ...
                  <!-- <hr>
                  <div class="text-center">
                    <a class="small" href="">Masuk Sebagai Admin!</a>
                  </div> -->
                </div>
              </div>
            </div>
